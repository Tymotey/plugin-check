...
class AJAX_Runner extends Abstract_Check_Runner
{
	...
	/**
	 * Returns debug check state.
	 *
	 * @since 1.0.0 //TODO: correct version
	 *
	 * @return string Return checked state(true/false).
	 */
	protected function get_debug_param()
	{
		$debug = filter_input(INPUT_POST, 'debug', FILTER_DEFAULT);
