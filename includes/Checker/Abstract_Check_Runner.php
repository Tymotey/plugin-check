...
abstract class Abstract_Check_Runner implements Check_Runner
{
	...
	/**
	 * Sets debug to correct value.
	 *
	 * @since 1.0.0 //TODO: correct version
	 *
	 * @param string $value State of input.
	 */
	final public function set_debug($value)
	{
		$this->debug = $value;
	}
	...
	private function get_check_context()
	{
		...
		return new Check_Context($plugin_path, $this->get_slug(), $this->get_debug());
	}
