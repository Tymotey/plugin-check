(function (pluginCheck) {
    ...
    const debugInput = document.getElementById("pcp_debug");
    const templates = {};
    ...
    function saveUserSettings() {
        ...
        // Save debug setting value.
        window.setUserSetting("plugin_check_debug", debugInput.checked);
    }
    ...
    // Attach the saveUserSettings function when debug is clicked.
    debugInput.addEventListener("change", saveUserSettings);
    ...
    function setUpEnvironment(data) {
        ...
        pluginCheckData.append("debug", debugInput.checked);
